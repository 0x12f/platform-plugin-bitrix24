 ...
 * @version 1.36
 *  define:
 *      C_REST_WEB_HOOK_URL = 'https://crm.int-klimat.ru/rest/1/p03yz2pexzdarssa/'  //url on creat Webhook
 *      or
...
class crest
{
    ...
    protected static function callCurl($arParams)
    {
        ...
        if ($arSettings !== false) {
            ...
            try {
                ...
                curl_setopt($obCurl, CURLOPT_FOLLOWLOCATION, (isset($arParams['followlocation']))
    ...
    /**
     * @param mixed $arSettings
     * @param mixed $isInstall
     *
     * @return bool
